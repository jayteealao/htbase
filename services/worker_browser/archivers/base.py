...
from common.models import ArchiveResult
...
class BaseArchiver(abc.ABC):
    ...
    def update_database_storage(
        ...
        try:
            from common.storage.database_storage import ArchiveArtifact, ArchiveStatus
    ...
    def _update_firestore_article_status(
        ...
        Args:
            ...
            upload_results: List of upload results from common.storage providers
        """
        import logging
        from datetime import datetime
        ...
        try:
            ...
            from common.storage.database_storage import ArchiveStatus
            self.db_storage.update_artifact_status(
                item_id=item_id,
                archiver=self.name,
