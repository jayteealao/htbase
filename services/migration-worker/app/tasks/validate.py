...
@celery_app.task(name="services.migration_worker.tasks.compare_counts")
...
@celery_app.task(name="services.migration_worker.tasks.validate_migration")
...
@celery_app.task(name="services.migration_worker.tasks.find_missing_records")
...
@celery_app.task(name="services.migration_worker.tasks.get_migration_stats")
