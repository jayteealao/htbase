...
@celery_app.task(name="services.migration_worker.tasks.rollback_migration")
...
@celery_app.task(name="services.migration_worker.tasks.delete_migrated_data")
...
@celery_app.task(name="services.migration_worker.tasks.pause_migration")
...
@celery_app.task(name="services.migration_worker.tasks.reset_migration_progress")
