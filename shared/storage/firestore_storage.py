...
class FirestoreStorage(DatabaseStorageProvider):
    ...
    def create_article(self, metadata: ArticleMetadata) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to create article {metadata.item_id}: {e}")
            return False
    ...
    def update_article_metadata(self, item_id: str, metadata: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.warning(f"Article {item_id} not found for update")
            return False
        except Exception as e:
    ...
    def create_artifact(self, artifact: ArchiveArtifact) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Failed to create artifact for {artifact.item_id}: {e}")
                return False

        except Exception as e:
            logger.error(f"Failed to update artifact for {artifact.item_id}: {e}")
            return False
    ...
    def update_artifact_status(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Failed to update artifact status for {item_id}/{archiver}: {e}")
            return False
    ...
    def create_pocket_data(self, pocket: PocketData) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Failed to create pocket data for {pocket.item_id}: {e}")
                return False

        except Exception as e:
            logger.error(f"Failed to update pocket data for {pocket.item_id}: {e}")
            return False
    ...
    def get_pocket_data(self, item_id: str) -> Optional[PocketData]:
        ...
        try:
            ...
            logger.error(f"Failed to get pocket data for {item_id}: {e}")
            return None
    ...
    def create_summary(self, summary: ArticleSummary) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to create summary for {summary.item_id}: {e}")
            return False
    ...
    def get_summary(self, item_id: str) -> Optional[ArticleSummary]:
        ...
        try:
            ...
            return ArticleSummary(
                ...
                bullet_points=summary_data.get("bulletPoints"),
                model_name=summary_data.get("modelName"),
    ...
    def batch_update_artifacts(self, artifacts: List[ArchiveArtifact]) -> int:
        ...
        try:
            ...
            logger.error(f"Batch update failed after {count} artifacts: {e}")
            return count
    ...
    def count_articles(self, filters: Optional[Dict[str, Any]] = None) -> int:
        ...
        try:
            ...
            # Firestore count aggregation (requires Firestore >= 2.0)
            # For older versions, fall back to streaming all docs
            try:
                count_query = query.count()
                result = count_query.get()
                return result[0][0].value
            except AttributeError:
                # Fallback for older Firestore client
                docs = list(query.stream())
                return len(docs)
    ...
    def _doc_to_article_record(self, data: Dict[str, Any]) -> Optional[ArticleRecord]:
        ...
        try:
            ...
            logger.error(f"Failed to convert document to ArticleRecord: {e}")
            return None
    ...
    def _dict_to_artifact(
        ...
        try:
            ...
            logger.error(f"Failed to convert dict to ArchiveArtifact: {e}")
            return None
