...
Implementations: LocalFileStorage, GCSFileStorage, etc.
"""
...
class FileStorageProvider(ABC):
    ...
    @abstractmethod
    def download_file(
        self, storage_path: str, local_path: Path, decompress: bool = True
    ) -> bool:
        """
    ...
    def generate_access_url(
        self, storage_path: str, expiration: timedelta = timedelta(days=7)
    ) -> str:
        """
    ...
    @abstractmethod
    def serve_file(
        self, storage_path: str, filename: str, media_type: str = "application/octet-stream"
    ):
        """
