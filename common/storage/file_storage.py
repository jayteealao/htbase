...
class FileStorageProvider(ABC):
    ...
    def download_file(
        ...
        """
        Download a file from common.storage.
    ...
    def delete_file(self, storage_path: str) -> bool:
        """
        Delete a file from common.storage.
    ...
    def serve_file(
        ...
        """
        Serve a file for download by streaming from common.storage.
    ...
    def download_to_temp(self, storage_path: str) -> Path:
        """
        Download a file from common.storage to a temporary location.
